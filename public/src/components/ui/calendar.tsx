...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar p-4 border-2 rounded-xl [--cell-size:--spacing(8)]",
      ...
      classNames={{
        ...
        today: cn(
          "bg-secondary/70 text-accent-foreground rounded-md data-[selected=true]:rounded-none",
